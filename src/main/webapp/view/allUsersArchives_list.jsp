...
<body onload="load()">
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a>职工管理</a> <a> <cite>职工档案管理</cite></a>
		</span> <a class="layui-btn layui-btn-small"
			style="line-height: 1.6em; margin-top: 3px; float: right"
			href="userArchivesController/toUserListArchives.do" title="刷新"> <i
	...
	<div class="x-body">
		<div class="layui-row">
			...
			<!-- 这个地方等于就是改造后台查询方法 -->
			<form class="layui-form layui-col-md12 x-so" method="post" action="userArchivesController/toUserListArchives.do">
				<span>档案查询：</span>
				 					
					
					<!-- 这儿的name值是后台写sql语句需要的EL表达式值 -->
				 <input class="layui-input" placeholder="请输档案名"	name="a_name"> 
	...
	<!-- 	<div class="layui-row">
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加档案','userArchivesController/addUIArchives.do',500,500)">
			<i class="layui-icon">&#xe608;</i>添加档案
		</button>
		...
		<table class="layui-table">
			...
			<tbody>
				...
				<a tatile="修改" onclick="x_admin_show('修改档案','userArchivesController/updateUserArchives.do?a_id=${user.a_id}',500,500)">
				<i class="layui-icon">&#xe642; </i>
				 </a>				 
				 <!-- 将当前记录的userId传给函数 ，obj指当前对象，因为使用了forEach循环-->
				<a tatile="删除" onclick="user_del(this,'${user.a_id}')">
				<i class="layui-icon">&#xe640; </i>
				 </a>				 
				</td>
				</tr>
...
function user_del(obj,a_id){
	layer.msg("确定删除吗？",{
		...
		yes:function(index){
			$.ajax({
				type:"post",
				url:"userArchivesController/delUserArchives.ajax",
				data:{
					a_id:a_id
				},
				dataType:"text",
